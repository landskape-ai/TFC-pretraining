...
import numpy as np
from perform_training import one_epoch_contrastive, one_epoch_finetuning
from prepare_dataloaders import load_initial_data_contrastive
from prepare_miscellaneous import (obtain_criterion, print_metrics,
                                   save_config_weights, save_metrics,
                                   save_patient_representation, track_metrics)
...
def train_model(
    ...
    if phases[0] == "train":
        phases[
            0
        ] = "train1"  # Another hack because I don't understand the distinction b/w train and train1
    ...
    while stop_counter <= patience and epoch_count < num_epochs:
        ...
        for phase, inference in zip(phases, inferences):
            ...
            if inference == False:
                ...
                if (phase == "val" and epoch_loss < best_loss) or (
        ...
        if "train1" not in phases and "train" not in phases:
            ...
            "train1" in phases or "train" in phases
        ) and "obtain_representation" in downstream_task:
            break
